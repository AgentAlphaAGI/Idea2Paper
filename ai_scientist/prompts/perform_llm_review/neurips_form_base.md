...
5. Soundness: Please assign the paper a numerical rating on the following scale to indicate the soundness of the technical claims, experimental and research methodology and on whether the central claims are adequately supported with evidence.
  4: excellent
  3: good
  2: fair
  1: poor
